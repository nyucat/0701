...
public class BOSS2Controller : MonoBehaviour
{
    ...
    public void BOSS2Change()
    {
        ...
        {
            if (distanceBOSS2 < 4 && player_ref.GetComponent<PlayerController>().attack_control)
            {
                currentHP -= 10;
            }
        }

        else if (distanceBOSS2 < 8&&player_ref.GetComponent<PlayerController>().is_bigskill_start)
        {
            currentHP -= 3;
        }
    }
